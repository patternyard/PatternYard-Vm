            ...
            blocks: [
                {
                    ...
                    arguments: {
                        URL: {
                            ...
                            defaultValue: `https://corsproxy.io/?${encodeURIComponent('https://patternyard.dev/Sprite1.pms')}`
                        }
                    },
                    switches: [
                        noopSwitch,
                ...
                },
                {
                    ...
                    arguments: {
                        URL: {
                            type: ArgumentType.STRING,
                            defaultValue: `https://corsproxy.io/?${encodeURIComponent('https://patternyard.dev/navicon.png')}`
                        },
                        name: {
                            type: ArgumentType.STRING,
